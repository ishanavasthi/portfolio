(function () {
    ...
    onvisible.add("h1.style1, h2.style1, h3.style1, p.style1", { style: "fade-left", speed: 1000, intensity: 1, delay: 0, staggerOrder: "", state: true, replay: false });
    onvisible.add("h1.style3, h2.style3, h3.style3, p.style3", { style: "fade-left", speed: 1000, intensity: 1, delay: 125, staggerOrder: "", state: true, replay: false });
    onvisible.add(".buttons.style1", { style: "fade-right", speed: 1000, intensity: 1, delay: 0, stagger: 125, state: true, replay: false });
    onvisible.add(".buttons.style2", { style: "fade-right", speed: 1000, intensity: 1, delay: 0, stagger: 125, state: true, replay: false });
    onvisible.add(".buttons.style4", { style: "fade-right", speed: 1000, intensity: 1, delay: 0, stagger: 125, state: true, replay: false });
    onvisible.add("#icons01", { style: "blur-in", speed: 1000, intensity: 5, delay: 0, state: true, replay: false });
})();